...
@Listeners(org.uncommons.reportng.HTMLReporter.class)
	...
	@Test
	public void Addsourcecontrol(@Optional String param,@Optional String param1,@Optional String cloud) throws  IOException, AWTException, InterruptedException{
		utility.Addsourcecontrol(param, param1);
	
	}
	@Parameters({"param", "Depends","suiteName","cloud"})
	@Test
	public void Addsourcecontrolvalidation(@Optional String param,@Optional String Depends,@Optional String suiteName,@Optional String cloud) throws  IOException, AWTException, InterruptedException{
		...
		utility.Addsourcecontrolvalidation(param);
	...
	@Test
	public void sourceControlDeletion(@Optional String param,@Optional String cloud) throws InterruptedException, IOException {
		  utility.sourceControlDeletion(param);
	}
	@Parameters({"param", "Depends","suiteName","cloud"})
	@Test
	public void sourceControlDeletionValidation(@Optional String param,@Optional String Depends,@Optional String suiteName,@Optional String cloud) throws InterruptedException, IOException {
		FileInputStream skip = new FileInputStream(workspace + "/src/file.Properties");
		  prop.load(skip);
		  if (prop.getProperty(cloud+suiteName+Depends).equals("FAIL") ) {throw new SkipException("Skip");}
		  utility.sourceControlDeletionValidation(param);
	}
	@Parameters({"param", "Depends","suiteName","cloud"})
	@Test
	...
	@Parameters({"param","cloud"})
	@Test
	public void createCluster(@Optional String param,@Optional String cloud) throws InterruptedException, IOException {
		if(cloud.equals("Google")){
		utility.createCluster(param);
		}
		else{
			utility.createAzureCluster(param);
		}
	}
	@Parameters({"param", "Depends","suiteName","cloud"})
	@Test
	public void clusterValidation(@Optional String param, @Optional String Depends,@Optional String suiteName,@Optional String cloud) throws InterruptedException, IOException {
		FileInputStream skip = new FileInputStream(workspace + "/src/file.Properties");
		  prop.load(skip);
		  if (prop.getProperty(cloud+suiteName+Depends).equals("FAIL")) {throw new SkipException("Skip");}
		 utility.clusterValidation(param);
	}
	@Parameters({"param","cloud"})
	@Test
	public void clusterDeletion(@Optional String param,@Optional String cloud) throws InterruptedException, IOException {
		  if(cloud.equals("Google")){
		utility.clusterDeletion(param);
		}
		  else
		  {
			  utility.azurClusterDeletion(param);
		  }
	}
	@Parameters({"param","cloud", "Depends","suiteName"})
	@Test
	public void clusterDeletionvalidation(@Optional String param,@Optional String cloud, @Optional String Depends,@Optional String suiteName) throws InterruptedException, IOException {
		FileInputStream skip = new FileInputStream(workspace + "/src/file.Properties");
		  prop.load(skip);
		  if (prop.getProperty(cloud+suiteName+Depends).equals("FAIL") || prop.getProperty(cloud+suiteName+Depends).equals("SKIP") ) {throw new SkipException("Skip");}
		 if(cloud.equals("Google")){
		  utility.clusterDeletionvalidation(param);
		 }
		 else{
			 utility.deleteAzureValidation(param);
		 }
	}
